                ...
                <div class="parking-details">
                    <div class="main-area">
                        ...
                        <div class="parking-directions">
                            <form action="<?php echo URLROOT?>/merchandiser/confirmRequestParking" method="post">
                                <input type="text" value="<?php echo $data->mergedLandID?>" required hidden name="mergeID" id="mergeID">
                                <input type="text" value="<?php echo $data->id?>" name="otherBaseLandID" hidden required >
                                ...
                                <button type="submit" style="border: none; outline: none; display: flex; justify-content: space-between; align-items: center; border-radius: 10px; padding: 5px 10px; background-color: #fccc04; color: white; width: 150px;">
                                    Confirm Parking<img class="parking-option-icon" src="<?php echo URLROOT ?>/images/Enter.png" alt="Parking" style="padding: 4px 0;">
                                </button>
                            </form>
